                ...
                return (
                    <div key={i} className="border-b border-white/[0.06]">
                        <button
                            ...
                            className="flex w-full items-center justify-between py-4 sm:py-5 text-left text-sm font-medium text-slate-300 hover:text-slate-100 transition-colors duration-300"
                        ...
                        >
                            <div className="overflow-hidden">
                                <div
                                    className={cn(
                                        "text-sm text-slate-400 leading-relaxed transition-opacity duration-500",
